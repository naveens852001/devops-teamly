  ...
  return (
    <div className=" pt-4 px-5 pb-0">
      <div className="card shadow-lg p-6 mb-6 rounded-lg bg-white">
        <h2 className="text-center text-2xl font-montserrat text-gray-800">
          Employee Onboarding
        </h2>
        ...
        <div className="dashboard flex justify-between">
          <div className="left-panel flex-1 mx-2 bg-white p-6 border border-gray-300 rounded-lg shadow-md">
            <div className="section mb-6">
              <h3 className="text-xl font-montserrat text-gray-700">
                Training Modules
              </h3>
              <form onSubmit={addTrainingModule} className="space-y-4">
                ...
                >
                  <option value="" disabled selected>
                    Select The Respective Department
                  </option>
                  <option value="IT">IT</option>
                  <option value="Software">Management</option>
                </select>
                <button
                  className="bg-gray-800 text-white py-2 px-4 rounded-lg hover:bg-black transition"
                  type="submit"
                >
                  Add Module
                </button>
              ...
              <div className="list-container mt-4">
                <ul className="training-modules space-y-2">
                  {trainingModules.map((module) => (
                    <li
                      className="module-item flex justify-between items-center p-2 border border-gray-200 rounded-lg bg-gray-100"
                      key={module._id}
                    >
                      ...
                      <button
                        ...
                        onClick={() => closeModule(module._id)}
                      >
                        Close
                      </button>
                    </li>
