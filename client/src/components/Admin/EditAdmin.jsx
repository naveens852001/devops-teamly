...
const apiUrl = import.meta.env.VITE_API_URL || "http://localhost:10000";
  ...
  const validateForm = () => {
    ...
    const trimmedMobile = String(employee.mobilenumber).trim();
    if (!trimmedMobile) {
      errors.mobilenumber = "Mobile Number is required";
  ...
  return (
    <div className="my-8  px-3 bg-gray-200 md:mx-auto max-h-screen  overflow-y-auto">
      <h3 className=" font-montserrat font-normal text-3xl pt-3 text-center mr-5">
        Admin-Profile
      </h3>
        ...
        <div className="lg:w-1/2 p-2 md:w-2/6 mt-2  ">
          <div className="rounded-lg p-4 bg-white  shadow-lg transform transition-transform duration-300 hover:scale-105">
            <div className="flex items-center bg-gray-800 text-white rounded-t-lg p-3">
              <i className=" bi-currency-rupee text-white text-2xl"></i>
      ...
      <div className="flex justify-start  px-5 py-3  mb-5">
        <button
          type="submit"
          className=" bg-gray-800 border px-3  py-2 mb-5 rounded text-white  add-employee  "
