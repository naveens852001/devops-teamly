...
5. Open a pull request.
 ...
 -->
<!-- in teamly devopsfarm  on admin side admin can see upcoming and past leaves of employess  he can see total employee count total admin  he can see upcoming event in a company  admin can also check list of admins and admin can also see pending leave request   admin can manage employee like add delete update he can check leave request he has two option accept or reject also leave req history where admin can see who req he accepted and rejected he also have payroll option where admin can pay salary to employee also  admin  can create event which will be orgainze in company he will select date from calendar then event discription will be add on employee side employee can see upcoming event with discription admin also have employee onboarding option where he can give training module to employee   admin also have update option where he can update his profile thats all about admin dashaboard now lets come to employee dashboard  where emp can  see on dashboard main page email of self his position his department he has upcoming event calender where with date event name highlighted which show upcoming event on this xyz date he has leave request column where he will saw  applied leave he can manage them like withdraw leave he has apply for leave  he can check pending request of him he has history which emp can check which leave accepted or rejected  he also have update profile where he can update his profile details he also have employee history form where employee can save his past experience of job and current job also  he has event tab where he can detailed event discription and event calender  he also have training modules where assign module by admin he can see he has two option if module completed then he throw in complete train module and if its incompleted he can put module in them this is my overall project overview -->